<template>
     ...
     <div class="loan-form">
       ...
       <a-card title="Loan Details" class="mt-4">
             ...
             <a-col :span="8">
               <a-form-item label="Actions">
                 <div style="display: flex; gap: 10px">
                   ...
                   <a-button  type="primary" style="color: white;" :loading="disburseLoading" :disabled="disburseLoading" @click="disburseLoan">
                     Disburse
                   </a-button>
                 </div>
               </a-form-item>
   ...
   import AddCustomerForm from "../../components/loan/AddCustomerForm.vue";
     ...
     methods: {
       ...
       calculateMonthlySchedule() {
         ...
         if (deduct_upfront) {
           schedule.push({
             month: 0,
             due_date: start.format("YYYY-MM-DD"),
