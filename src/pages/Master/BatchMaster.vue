            ...
            <div class="md-layout-item md-medium-size-100 md-xsmall-size-100 md-size-100">
                <md-card>
                    <md-card-header data-background-color="green">
                        <h4 class="title">BATCH MASTERS</h4>
                    ...
                    <md-card-content>
                        <md-table v-model="users" :table-header-color="tableHeaderColor">
                            <md-table-row slot="md-table-row" slot-scope="{ item }">
                                ...
                                <md-table-cell md-label="Batch Id">{{ item.id }}</md-table-cell>
                                <md-table-cell md-label="Batch Name/Code">{{ item.code }}</md-table-cell>
                            </md-table-row>
                        </md-table>
                    </md-card-content>
                </md-card>
            ...
            <form>
                <div class="md-layout-item md-medium-size-100 md-xsmall-size-100 md-size-100">
                    <md-card style="width: 55%;">
                        <md-card-header data-background-color="green">
                            <h4 class="title">BATCH MASTER</h4>
...
export default {
    ...
    data() {
        return {
            ...
            users: [
                { Sl_no: "1", id: "B001", code: "*B-27"},
                { Sl_no: "2", id: "B002", code: "*B-28"},
                { Sl_no: "3", id: "B003", code: "*B-29"},
                { Sl_no: "4", id: "B004", code: "*B-30"},
            ],
        };
    },
    methods: {
