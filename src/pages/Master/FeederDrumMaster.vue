            ...
            <div class="row align-items-center mb-3">
                ...
                <div class="col-auto">
                    <ul class="nav nav-pills">
                        <li class="nav-item">
                            <a href="#" :class="['nav-link', { active: isActive('list') }]"
                                @click.prevent="setActiveTab('list')">
                                List
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="#" :class="['nav-link', { active: isActive('apply') }]"
                    ...
                    <md-card-content>
                        <md-table v-model="users" :table-header-color="tableHeaderColor">
                            <md-table-row slot="md-table-row" slot-scope="{ item }">
                                ...
                                <md-table-cell md-label="PST">{{ item.PST }}</md-table-cell>
                                <md-table-cell md-label="ST">{{ item.ST }}</md-table-cell>
                                <md-table-cell md-label="FN1">{{ item.FN1 }}</md-table-cell>
                                <md-table-cell md-label="FN2">{{ item.FN2 }}</md-table-cell>
                            </md-table-row>
                        </md-table>
                    </md-card-content>
                </md-card>
...
<div class="form-group">
    ...
    <div class="row">
        ...
        <div class="col">
            <md-field>
                <label>ST</label>
                <md-input v-model="field1" type="text"></md-input>
            </md-field>
        </div>
        ...
        <div class="col">
            <md-field>
                <label>FN2</label>
                <md-input v-model="field2" type="text"></md-input>
            </md-field>
        </div>
    </div>
</div>
...
export default {
    ...
    data() {
        return {
            ...
            users: [
                { Sl_no: "1", PST: "1.150", ST: "2.090", FN1: "1.230", FN2: "3.210" },
                { Sl_no: "2", PST: "1.230", ST: "2.040", FN1: "1.240", FN2: "1.200" },
                { Sl_no: "3", PST: "1.302", ST: "2.030", FN1: "1.210", FN2: "2.200" },
            ],
        };
    },
    methods: {
