...
export default {
    ...
    data() {
        return {
            ...
            users: [
                { Sl_no: "1", tg_id: "T1PC001", group_name: "Trial Group 1" },
                { Sl_no: "2", tg_id: "T2PC001", group_name: "Trial Group 2" },
                { Sl_no: "3", tg_id: "T3PC001", group_name: "Trial Group 3" },
                { Sl_no: "4", tg_id: "T4PC001", group_name: "Trial Group 4" },
            ],
        };
    },
    methods: {
