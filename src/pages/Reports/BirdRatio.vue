          ...
          <md-card-content>
            ...
            >
              <tr>
                <th>Group</th>
                <th>Male Birds</th>
                <th>Male Birds Body Wt</th>
                <th>Female Birds</th>
                <th>Female Birds Body Wt</th>
                <th>Total Body Wt</th>
                <th>Group Avg</th>
                <th>FCR</th>
              </tr>

              <tr v-for="item in users" :key="item.Group">           <!--item-grp?-->
                <td>{{ item.Group }}</td>
                <td>{{ item.Male_Birds }}</td>
                <td>{{ item.Male_Wt }}</td>
                <td>{{ item.Female_Birds }}</td>
                <td>{{ item.Female_Wt }}</td>
                <td>{{ item.Total_wt }}</td>
                <td>{{ item.Group_avg }}</td>
                <td>{{ item.FCR }}</td>
              </tr>
